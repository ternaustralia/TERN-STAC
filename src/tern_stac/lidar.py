...
def laz_to_canopy_height(*args, **kwargs):
    raise NotImplementedError(
        "laz_to_canopy_height has been removed from the public API as it's not a proper CHM function. "
        "See `lidar_chm_api_workflow.ipynb` example notebook for details."
    )
